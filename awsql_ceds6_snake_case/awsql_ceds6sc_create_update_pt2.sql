...
COMMENT ON COLUMN ceds6sc.k12_lea.ref_lea_improvement_status_id IS 'An indication of the improvement stage for AYP of the local education agency (LEA). [CEDS Element: Local Education Agency Improvement Status, ID:000173]  (Foreign key - Ref_LEA_Improvement_Status)';
...
COMMENT ON COLUMN ceds6sc.k12_lea_federal_reporting.organization_id IS 'Inherited surrogate key from K12Lea.';
...
COMMENT ON COLUMN ceds6sc.k12_lea_pre_k_eligible_ages_idea.organization_id IS 'Surrogate key from K12LEA';
...
COMMENT ON COLUMN ceds6sc.k12_lea_title_iii_professional_development.organization_id IS 'Surrogate key from K12LEA';
...
COMMENT ON COLUMN ceds6sc.k12_school_status.organization_id IS 'Inherited surrogate key from K12School.';
...
COMMENT ON COLUMN ceds6sc.k12_sea_alternate_fund_use.organization_id IS 'Surrogate key from K12SEAFederal_Funds';
...
COMMENT ON COLUMN ceds6sc.k12_sea_federal_funds.organization_id IS 'Inherited surrogate key from K12SEA';
...
COMMENT ON COLUMN ceds6sc.k12_staff_employment.title_i_targeted_assistance_staff_funded IS 'An indication that a staff member is targeted assistance (TAS) program staff funded by Title I, Part A, Section 1115 of ESEA as amended. [CEDS Element: Title I Targeted Assistance Staff Funded, ID:000552]';
...
COMMENT ON COLUMN ceds6sc.k12_student_course_section_mark.organization_person_role_id IS 'Foreign key - K12Student_Course_Section';
...
COMMENT ON COLUMN ceds6sc.k12_student_graduation_plan.k12_course_id IS 'Foreign key - K12Course.';
...
COMMENT ON COLUMN ceds6sc.learning_resource.ref_learning_resource_access_api_type_id IS 'Indicates that the learning resource is compatible with the referenced accessibility application programming interface (API). [CEDS Element: Learning Resource Access API Type, ID:001389]';
...
CREATE TABLE ceds6sc.program_participation_title_i_ ( 
	organization_person_role_id integer  NOT NULL,
	ref_title_i_indicator_id integer  ,
	CONSTRAINT pk_program_participation_title_i_ PRIMARY KEY ( organization_person_role_id )
 );

COMMENT ON TABLE ceds6sc.program_participation_title_i_ IS 'Information on a person participating in a Title I education program.';

COMMENT ON COLUMN ceds6sc.program_participation_title_i_.organization_person_role_id IS 'Surrogate key from Person_Program_Participation';

COMMENT ON COLUMN ceds6sc.program_participation_title_i_.ref_title_i_indicator_id IS 'An indication that the student is participating in and served by programs under Title I, Part A of ESEA as amended. [CEDS Element: Title I Indicator, ID:000281]';
...
COMMENT ON COLUMN ceds6sc.ps_program.ref_ps_program_level_id IS 'The level describing the concentration of study for a postsecondary program. [CEDS Element: Postsecondary Program Level, ID:001616]';

COMMENT ON COLUMN ceds6sc.ps_program.ref_dqpcategories_of_learning_id IS 'The Lumina Foundation''s Degree Qualifications Profile offers reference points for what students should know and be able to do upon completion of associate, bachelor''s and master''s degrees – in any field of study. The DQP Categories of Learning provide a profile of what degrees mean within which specific proficiencies may be defined. [CEDS Element: DQP Categories of Learning, ID:001641]';
...
CREATE TABLE ceds6sc.ref_assessment_el_developmental_domain ( 
...
COMMENT ON TABLE ceds6sc.ref_assessment_el_developmental_domain IS 'Developmental domains related to early learning and used for assessing a child''s kindergarten readiness.[CEDS Element: Assessment Early Learning Developmental Domain, ID:001000]';

COMMENT ON COLUMN ceds6sc.ref_assessment_el_developmental_domain.ref_assessment_el_developmental_domain_id IS 'Surrogate Key';

COMMENT ON COLUMN ceds6sc.ref_assessment_el_developmental_domain.description IS 'Developmental domains related to early learning and used for assessing a child''s kindergarten readiness. [CEDS Element: Assessment Early Learning Developmental Domain, ID:001000]';

COMMENT ON COLUMN ceds6sc.ref_assessment_el_developmental_domain.code IS 'A code or abbreviation for the type.';

COMMENT ON COLUMN ceds6sc.ref_assessment_el_developmental_domain.ref_jurisdiction_id IS 'Surrogate key from Organization identifying the publisher of the reference value.';
...
COMMENT ON COLUMN ceds6sc.ref_course_gpa_applicability.ref_course_gpaapplicability_id IS 'Surrogate Key';
...
COMMENT ON COLUMN ceds6sc.ref_cte_non_traditional_gender_status.ref_cte_non_traditional_gender_status_id IS 'Surrogate Key';
...
COMMENT ON TABLE ceds6sc.ref_directory_information_block_status IS 'An indication of whether a individual requested a Family Education Rights and Privacy Act (FERPA) block to withhold the release of the person''s directory information.[CEDS Element: Directory Information Block Status, ID:001590]';
...
CREATE TABLE ceds6sc.ref_dqpcategories_of_learning ( 
...
COMMENT ON TABLE ceds6sc.ref_dqpcategories_of_learning IS 'The Lumina Foundation''s Degree Qualifications Profile offers reference points for what students should know and be able to do upon completion of associate, bachelor''s and master''s degrees – in any field of study. The DQP Categories of Learning provide a profile of what degrees mean within which specific proficiencies may be defined.[CEDS Element: DQP Categories of Learning, ID:001641]';

COMMENT ON COLUMN ceds6sc.ref_dqpcategories_of_learning.ref_dqpcategories_of_learning_id IS 'Surrogate Key';

COMMENT ON COLUMN ceds6sc.ref_dqpcategories_of_learning.description IS 'The Lumina Foundation''s Degree Qualifications Profile offers reference points for what students should know and be able to do upon completion of associate, bachelor''s and master''s degrees – in any field of study. The DQP Categories of Learning provide a profile of what degrees mean within which specific proficiencies may be defined. [CEDS Element: DQP Categories of Learning, ID:001641]';

COMMENT ON COLUMN ceds6sc.ref_dqpcategories_of_learning.code IS 'A code or abbreviation for the type.';

COMMENT ON COLUMN ceds6sc.ref_dqpcategories_of_learning.ref_jurisdiction_id IS 'Surrogate key from Organization identifying the publisher of the reference value.';
...
CREATE TABLE ceds6sc.ref_el_local_revenue_source ( 
...
COMMENT ON TABLE ceds6sc.ref_el_local_revenue_source IS 'Funds that originate at the local level, and not from the state or federal level, that contribute to EL program.[CEDS Element: Early Learning Local Revenue Source, ID:001603]';

COMMENT ON COLUMN ceds6sc.ref_el_local_revenue_source.ref_el_local_revenue_source_id IS 'Surrogate Key';

COMMENT ON COLUMN ceds6sc.ref_el_local_revenue_source.description IS 'Funds that originate at the local level, and not from the state or federal level, that contribute to EL program. [CEDS Element: Early Learning Local Revenue Source, ID:001603]';

COMMENT ON COLUMN ceds6sc.ref_el_local_revenue_source.code IS 'A code or abbreviation for the type.';

COMMENT ON COLUMN ceds6sc.ref_el_local_revenue_source.ref_jurisdiction_id IS 'Surrogate key from Organization identifying the publisher of the reference value.';
...
CREATE TABLE ceds6sc.ref_iso6392_language ( 
...
COMMENT ON TABLE ceds6sc.ref_iso6392_language IS 'The code for the specific language or dialect that a person uses to communicate.[CEDS Element: ISO 639-2 Language Code, ID:000317]';

COMMENT ON COLUMN ceds6sc.ref_iso6392_language.ref_iso6392_language_id IS 'Surrogate Key';

COMMENT ON COLUMN ceds6sc.ref_iso6392_language.description IS 'The code for the specific language or dialect that a person uses to communicate. [CEDS Element: ISO 639-2 Language Code, ID:000317]';

COMMENT ON COLUMN ceds6sc.ref_iso6392_language.code IS 'A code or abbreviation for the type.';

COMMENT ON COLUMN ceds6sc.ref_iso6392_language.ref_jurisdiction_id IS 'Surrogate key from Organization identifying the publisher of the reference value.';

CREATE TABLE ceds6sc.ref_iso6395_language_family ( 
...
COMMENT ON TABLE ceds6sc.ref_iso6395_language_family IS 'A code for a specific language family, which supplements the language groups and families in the ISO 639-2 Language Code.[CEDS Element: ISO 639-5 Language Family, ID:001638]';

COMMENT ON COLUMN ceds6sc.ref_iso6395_language_family.ref_iso6395_language_family_id IS 'Surrogate Key';

COMMENT ON COLUMN ceds6sc.ref_iso6395_language_family.description IS 'A code for a specific language family, which supplements the language groups and families in the ISO 639-2 Language Code. [CEDS Element: ISO 639-5 Language Family, ID:001638]';

COMMENT ON COLUMN ceds6sc.ref_iso6395_language_family.code IS 'A code or abbreviation for the type.';

COMMENT ON COLUMN ceds6sc.ref_iso6395_language_family.ref_jurisdiction_id IS 'Surrogate key from Organization identifying the publisher of the reference value.';
...
CREATE TABLE ceds6sc.ref_learning_resource_access_api_type ( 
...
COMMENT ON TABLE ceds6sc.ref_learning_resource_access_api_type IS 'Indicates that the learning resource is compatible with the referenced accessibility application programming interface (API). [CEDS Element: Learning Resource Access API Type, ID:001389]';

COMMENT ON COLUMN ceds6sc.ref_learning_resource_access_api_type.ref_learning_resource_access_api_type_id IS 'Surrogate Key';

COMMENT ON COLUMN ceds6sc.ref_learning_resource_access_api_type.description IS 'Indicates that the learning resource is compatible with the referenced accessibility application programming interface (API). [CEDS Element: Learning Resource Access API Type, ID:001389]';

COMMENT ON COLUMN ceds6sc.ref_learning_resource_access_api_type.code IS 'A code or abbreviation for the type.';

COMMENT ON COLUMN ceds6sc.ref_learning_resource_access_api_type.ref_jurisdiction_id IS 'Surrogate key from Organization identifying the publisher of the reference value.';
...
COMMENT ON TABLE ceds6sc.ref_military_connected_student_indicator IS 'An indication that the student<U+0092>s parent or guardian is on Active Duty, in the National Guard, or in the Reserve components of the United States military services[CEDS Element: Military Connected Student Indicator, ID:001576]';
...
COMMENT ON COLUMN ceds6sc.ref_military_connected_student_indicator.description IS 'An indication that the student<U+0092>s parent or guardian is on Active Duty, in the National Guard, or in the Reserve components of the United States military services [CEDS Element: Military Connected Student Indicator, ID:001576]';
...
COMMENT ON TABLE ceds6sc.ref_restructuring_action IS 'The types of actions being implemented in Title I schools as a result of the school being in an improvement status of restructuring <U+0096> year 2 (implementation year). [CEDS Element: Restructuring Action, ID:000232]';

COMMENT ON COLUMN ceds6sc.ref_restructuring_action.ref_restructuring_action_id IS 'Surrogate Key';

COMMENT ON COLUMN ceds6sc.ref_restructuring_action.description IS 'The types of actions being implemented in Title I schools as a result of the school being in an improvement status of restructuring <U+0096> year 2 (implementation year). [CEDS Element: Restructuring Action, ID:000232]';
...
COMMENT ON COLUMN ceds6sc.staff_experience.years_of_prior_ae_teaching_experience IS 'The total number of years that a person has previously held a teaching position in one or more adult education programs. [CEDS Element: Years of Prior Adult Education Teaching Experience, ID:000788]';
...
COMMENT ON COLUMN ceds6sc.teacher_student_data_link_exclusion.student_organization_person_role_id IS 'Foreign key - K12Student_Course_Section.  Identifies the Student enrolled in a Course Section.';

COMMENT ON COLUMN ceds6sc.teacher_student_data_link_exclusion.teacher_organization_person_role_id IS 'Foreign key - K12Staff_Assignment.  Identifies the staff member assigned to a class/section.';
...
ALTER TABLE ceds6sc.assessment_asset ADD CONSTRAINT fk_assessment_asset_ref_assess_asset_idtype FOREIGN KEY ( ref_assessment_assest_identifier_type ) REFERENCES ceds6sc.ref_assessment_asset_identifier_type( ref_assessment_asset_identifier_type_id );

COMMENT ON CONSTRAINT FK_Assessment_Asset_Ref_Assess_Asset_IDType ON ceds6sc.assessment_asset IS '';
...
ALTER TABLE ceds6sc.assessment_subtest_el_developmental_domain ADD CONSTRAINT fk_assessment_subtest_assessment_el_developmental_domain_ref_assessment_el_developmental_domain FOREIGN KEY ( ref_assessment_el_developmental_domain_id ) REFERENCES ceds6sc.ref_assessment_el_developmental_domain( ref_assessment_el_developmental_domain_id );
...
ALTER TABLE ceds6sc.cte_course ADD CONSTRAINT fk_cte_course_ref_course_gpa_applicability FOREIGN KEY ( ref_course_gpa_applicability_id ) REFERENCES ceds6sc.ref_course_gpa_applicability( ref_course_gpaapplicability_id );
...
ALTER TABLE ceds6sc.financial_account ADD CONSTRAINT fk_financial_account_ref_financial_balance_sheet_account_code FOREIGN KEY ( ref_financial_account_balance_sheet_code_id ) REFERENCES ceds6sc.ref_financial_account_balance_sheet_code( ref_financial_balance_sheet_account_code_id );

COMMENT ON CONSTRAINT FK_Financial_Account_Ref_Financial_Balance_Sheet_Account_Code ON ceds6sc.financial_account IS '';

ALTER TABLE ceds6sc.financial_account ADD CONSTRAINT fk_financial_account_ref_financial_account_category FOREIGN KEY ( ref_financial_account_category_id ) REFERENCES ceds6sc.ref_financial_account_category( ref_financial_account_category_id );

COMMENT ON CONSTRAINT FK_Financial_Account_Ref_Financial_Account_Category ON ceds6sc.financial_account IS '';

ALTER TABLE ceds6sc.financial_account ADD CONSTRAINT fk_financial_account_ref_financial_account_fund_classification FOREIGN KEY ( ref_financial_account_fund_classification_id ) REFERENCES ceds6sc.ref_financial_account_fund_classification( ref_financial_account_fund_classification_id );

COMMENT ON CONSTRAINT FK_Financial_Account_Ref_Financial_Account_Fund_Classification ON ceds6sc.financial_account IS '';

ALTER TABLE ceds6sc.financial_account ADD CONSTRAINT fk_financial_account_ref_financial_account_program_code FOREIGN KEY ( ref_financial_account_program_code_id ) REFERENCES ceds6sc.ref_financial_account_program_code( ref_financial_account_program_code_id );

COMMENT ON CONSTRAINT FK_Financial_Account_Ref_Financial_Account_Program_Code ON ceds6sc.financial_account IS '';

ALTER TABLE ceds6sc.financial_account ADD CONSTRAINT fk_financial_account_ref_financial_account_revenue_code FOREIGN KEY ( ref_financial_account_revenue_code_id ) REFERENCES ceds6sc.ref_financial_account_revenue_code( ref_financial_account_revenue_code_id );

COMMENT ON CONSTRAINT FK_Financial_Account_Ref_Financial_Account_Revenue_Code ON ceds6sc.financial_account IS '';

ALTER TABLE ceds6sc.financial_account ADD CONSTRAINT fk_financial_account_ref_financial_expenditure_function_code FOREIGN KEY ( ref_financial_expenditure_function_code_id ) REFERENCES ceds6sc.ref_financial_expenditure_function_code( ref_financial_expenditure_function_code_id );

COMMENT ON CONSTRAINT FK_Financial_Account_Ref_Financial_Expenditure_Function_Code ON ceds6sc.financial_account IS '';

ALTER TABLE ceds6sc.financial_account ADD CONSTRAINT fk_financial_account_ref_financial_expenditure_level_of_instruction_code FOREIGN KEY ( ref_financial_expenditure_level_of_instruction_code_id ) REFERENCES ceds6sc.ref_financial_expenditure_level_of_instruction_code( ref_financial_expenditure_level_of_instruction_code_id );

COMMENT ON CONSTRAINT FK_Financial_Account_Ref_Financial_Expenditure_Level_Of_Instruction_Code ON ceds6sc.financial_account IS '';

ALTER TABLE ceds6sc.financial_account ADD CONSTRAINT fk_financial_account_ref_financial_expenditure_object_code FOREIGN KEY ( ref_financial_expenditure_object_code_id ) REFERENCES ceds6sc.ref_financial_expenditure_object_code( ref_financial_expenditure_object_code_id );

COMMENT ON CONSTRAINT FK_Financial_Account_Ref_Financial_Expenditure_Object_Code ON ceds6sc.financial_account IS '';
...
ALTER TABLE ceds6sc.k12_course ADD CONSTRAINT fk_k12_course_ref_course_gpaapplicability FOREIGN KEY ( ref_course_gpa_applicability_id ) REFERENCES ceds6sc.ref_course_gpa_applicability( ref_course_gpaapplicability_id );
...
ALTER TABLE ceds6sc.k12_lea_federal_funds ADD CONSTRAINT fk_k12_lea_federal_funds_ref_lea_funds_transfer_type FOREIGN KEY ( ref_lea_funds_transfer_type_id ) REFERENCES ceds6sc.ref_lea_funds_transfer_type( ref_lea_funds_transfer_type_id );

COMMENT ON CONSTRAINT FK_K12_LEA_Federal_Funds_Ref_LEA_Funds_Transfer_Type ON ceds6sc.k12_lea_federal_funds IS '';
...
ALTER TABLE ceds6sc.k12_lea_pre_k_eligibility ADD CONSTRAINT fk_k12_lea_pre_k_eligibility_ref_pre_kindergarten__eligibility FOREIGN KEY ( ref_pre_kindergarten__eligibility_id ) REFERENCES ceds6sc.ref_pre_kindergarten__eligibility( ref_pre_kindergarten__eligibility_id );

COMMENT ON CONSTRAINT FK_K12_Lea_Pre_K_Eligibility_Ref_Pre_Kindergarten__Eligibility ON ceds6sc.k12_lea_pre_k_eligibility IS '';
...
ALTER TABLE ceds6sc.k12_program_or_service ADD CONSTRAINT fk_k12_lea_program_or_service_ref_mep_project_type FOREIGN KEY ( ref_mep_project_type_id ) REFERENCES ceds6sc.ref_mep_project_type( ref_mep_project_type_id );

COMMENT ON CONSTRAINT FK_K12_LEA_Program_Or_Service_Ref_MEP_Project_Type ON ceds6sc.k12_program_or_service IS '';
...
ALTER TABLE ceds6sc.k12_program_or_service ADD CONSTRAINT fk_k12_lea_program_or_service_ref_program_day_length FOREIGN KEY ( ref_pre_kindergarten__daily_length_id ) REFERENCES ceds6sc.ref_program_day_length( ref_program_day_length_id );
...
ALTER TABLE ceds6sc.k12_school_improvement ADD CONSTRAINT fk_k12_school_improvement_ref_sigintervention_type FOREIGN KEY ( ref_sig_intervention_type_id ) REFERENCES ceds6sc.ref_sig_intervention_type( ref_sig_intervention_type_id );

COMMENT ON CONSTRAINT FK_K12_School_Improvement_Ref_SIGIntervention_Type ON ceds6sc.k12_school_improvement IS '';
...
ALTER TABLE ceds6sc.k12_student_course_section ADD CONSTRAINT fk_k12_student_course_section_ref_course_gpa_applicability FOREIGN KEY ( ref_course_gpa_applicability_id ) REFERENCES ceds6sc.ref_course_gpa_applicability( ref_course_gpaapplicability_id );
...
ALTER TABLE ceds6sc.k12_title_iii_language_instruction ADD CONSTRAINT fk_k12_lea_title_iii_lang_instruction_ref_title_iii_lang_instruction_prgm FOREIGN KEY ( ref_title_iii_language_instruction_program_type_id ) REFERENCES ceds6sc.ref_title_iii_language_instruction_program_type( ref_title_iii_language_instruction_program_type_id );

COMMENT ON CONSTRAINT FK_K12_Lea_Title_III_Lang_Instruction_Ref_Title_III_Lang_Instruction_Prgm ON ceds6sc.k12_title_iii_language_instruction IS '';
...
ALTER TABLE ceds6sc.learning_resource_adaptation ADD CONSTRAINT fk_learning_resource_adaptation_lr FOREIGN KEY ( learning_resource_id ) REFERENCES ceds6sc.learning_resource( learning_resource_id );

COMMENT ON CONSTRAINT FK_Learning_Resource_Adaptation_LR ON ceds6sc.learning_resource_adaptation IS '';

ALTER TABLE ceds6sc.learning_resource_media_feature ADD CONSTRAINT fk_learning_resource_media_feature_learning_resource FOREIGN KEY ( learning_resource_id ) REFERENCES ceds6sc.learning_resource( learning_resource_id );

COMMENT ON CONSTRAINT FK_Learning_Resource_Media_Feature_Learning_Resource ON ceds6sc.learning_resource_media_feature IS '';

ALTER TABLE ceds6sc.learning_resource_media_feature ADD CONSTRAINT fk_learning_resource_media_feature_ref_learning_resource_media_feature_type FOREIGN KEY ( ref_learning_resource_media_feature_type_id ) REFERENCES ceds6sc.ref_learning_resource_media_feature_type( ref_learning_resource_media_feature_type_id );

COMMENT ON CONSTRAINT FK_Learning_Resource_Media_Feature_Ref_Learning_Resource_Media_Feature_Type ON ceds6sc.learning_resource_media_feature IS '';

ALTER TABLE ceds6sc.learning_resource_physical_media ADD CONSTRAINT fk_learning_resource_physical_media_learning_resource FOREIGN KEY ( learning_resource_id ) REFERENCES ceds6sc.learning_resource( learning_resource_id );

COMMENT ON CONSTRAINT FK_Learning_Resource_Physical_Media_Learning_Resource ON ceds6sc.learning_resource_physical_media IS '';

ALTER TABLE ceds6sc.learning_resource_physical_media ADD CONSTRAINT fk_learning_resource_physical_media_ref_learning_resource_physical_media_type FOREIGN KEY ( ref_learning_resource_physical_media_type_id ) REFERENCES ceds6sc.ref_learning_resource_physical_media_type( ref_learning_resource_physical_media_type_id );

COMMENT ON CONSTRAINT FK_Learning_Resource_Physical_Media_Ref_Learning_Resource_Physical_Media_Type ON ceds6sc.learning_resource_physical_media IS '';
...
ALTER TABLE ceds6sc.program_participation_migrant ADD CONSTRAINT fk_program_participation_migrant_ref_mep_project_based FOREIGN KEY ( ref_mep_project_based_id ) REFERENCES ceds6sc.ref_mep_project_based( ref_mep_project_based_id );

COMMENT ON CONSTRAINT FK_Program_Participation_Migrant_Ref_MEP_Project_Based ON ceds6sc.program_participation_migrant IS '';

ALTER TABLE ceds6sc.program_participation_migrant ADD CONSTRAINT fk_program_participation_migrant_ref_mep_service_type FOREIGN KEY ( ref_mep_service_type_id ) REFERENCES ceds6sc.ref_mep_service_type( ref_mep_service_type_id );

COMMENT ON CONSTRAINT FK_Program_Participation_Migrant_Ref_MEP_Service_Type ON ceds6sc.program_participation_migrant IS '';
...
ALTER TABLE ceds6sc.ps_section ADD CONSTRAINT fk_ps_section_ref_course_gpa_applicability FOREIGN KEY ( ref_course_gpa_applicability_id ) REFERENCES ceds6sc.ref_course_gpa_applicability( ref_course_gpaapplicability_id );
...
ALTER TABLE ceds6sc.ps_student_financial_aid ADD CONSTRAINT fk_ps_student_financial_aid_ref_fin_aid_vtrns_bnft_status FOREIGN KEY ( ref_financial_aid_veterans_benefit_status_id ) REFERENCES ceds6sc.ref_financial_aid_veterans_benefit_status( ref_financial_aid_veterans_benefit_status_id );

COMMENT ON CONSTRAINT FK_Ps_student_financial_aid_ref_fin_aid_vtrns_bnft_Status ON ceds6sc.ps_student_financial_aid IS '';

ALTER TABLE ceds6sc.ps_student_financial_aid ADD CONSTRAINT fk_ps_student_financial_aid_ref_fin_aid_vtrns_bnft_type FOREIGN KEY ( ref_financial_aid_veterans_benefit_type_id ) REFERENCES ceds6sc.ref_financial_aid_veterans_benefit_type( ref_financial_aid_veterans_benefit_type_id );

COMMENT ON CONSTRAINT FK_Ps_student_financial_aid_ref_fin_aid_vtrns_bnft_Type ON ceds6sc.ps_student_financial_aid IS '';
...
ALTER TABLE ceds6sc.quarterly_employment_record ADD CONSTRAINT fk_quarterly_employment_record_ref_eradministrative_data_source FOREIGN KEY ( ref_eradministrative_data_source_id ) REFERENCES ceds6sc.ref_eradministrative_data_source( ref_eradministrative_data_source_id );

COMMENT ON CONSTRAINT FK_Quarterly_Employment_Record_Ref_ERAdministrative_Data_Source ON ceds6sc.quarterly_employment_record IS '';
...
ALTER TABLE ceds6sc.ref_ae_certification_type ADD CONSTRAINT fk_ref_ae_certification_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_AE_Certification_Type_Organization ON ceds6sc.ref_ae_certification_type IS '';

ALTER TABLE ceds6sc.ref_ae_functioning_level_at_posttest ADD CONSTRAINT fk_ref_ae_functioning_level_at_posttest_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_AE_Functioning_Level_At_Posttest_Organization ON ceds6sc.ref_ae_functioning_level_at_posttest IS '';

ALTER TABLE ceds6sc.ref_ae_postsecondary_transition_action ADD CONSTRAINT fk_ref_ae_postsecondary_transition_action_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_AE_Postsecondary_Transition_Action_Organization ON ceds6sc.ref_ae_postsecondary_transition_action IS '';

ALTER TABLE ceds6sc.ref_ae_staff_classification ADD CONSTRAINT fk_ref_ae_staff_classification_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_AE_Staff_Classification_Organization ON ceds6sc.ref_ae_staff_classification IS '';
...
ALTER TABLE ceds6sc.ref_assessment_form_section_identification_system ADD CONSTRAINT fk_ref_assessment_form_section_idtype_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Assessment_Form_Section_IDType_Organization ON ceds6sc.ref_assessment_form_section_identification_system IS '';
...
ALTER TABLE ceds6sc.ref_assessment_subtest_identifier_type ADD CONSTRAINT fk_ref_assess_subtest_idtype_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Assess_Subtest_IDType_Organization ON ceds6sc.ref_assessment_subtest_identifier_type IS '';
...
ALTER TABLE ceds6sc.ref_el_level_of_specialization ADD CONSTRAINT fk_ref_el_level_of_specialization_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_EL_Level_Of_Specialization_Organization ON ceds6sc.ref_el_level_of_specialization IS '';

ALTER TABLE ceds6sc.ref_el_other_federal_funding_sources ADD CONSTRAINT fk_ref_el_other_federal_funding_sources_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_EL_Other_Federal_Funding_Sources_Organization ON ceds6sc.ref_el_other_federal_funding_sources IS '';

ALTER TABLE ceds6sc.ref_el_professional_development_topic_area ADD CONSTRAINT fk_ref_el_professional_development_topic_area_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_EL_Professional_Development_Topic_Area_Organization ON ceds6sc.ref_el_professional_development_topic_area IS '';

ALTER TABLE ceds6sc.ref_el_program_eligibility_status ADD CONSTRAINT fk_ref_el_program_eligibility_status_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_EL_Program_Eligibility_Status_Organization ON ceds6sc.ref_el_program_eligibility_status IS '';

ALTER TABLE ceds6sc.ref_el_service_professional_staff_classification ADD CONSTRAINT fk_ref_el_service_professional_staff_classification_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_EL_Service_Professional_Staff_Classification_Organization ON ceds6sc.ref_el_service_professional_staff_classification IS '';

ALTER TABLE ceds6sc.ref_el_state_revenue_source ADD CONSTRAINT fk_ref_el_state_revenue_source_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_EL_State_Revenue_Source_Organization ON ceds6sc.ref_el_state_revenue_source IS '';

ALTER TABLE ceds6sc.ref_eradministrative_data_source ADD CONSTRAINT fk_ref_eradministrative_data_source_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_ERAdministrative_Data_Source_Organization ON ceds6sc.ref_eradministrative_data_source IS '';
...
ALTER TABLE ceds6sc.ref_employed_after_exit ADD CONSTRAINT fk_ref_employed_after_exit_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Employed_After_Exit_Organization ON ceds6sc.ref_employed_after_exit IS '';

ALTER TABLE ceds6sc.ref_employed_while_enrolled ADD CONSTRAINT fk_ref_employed_while_enrolled_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Employed_While_Enrolled_Organization ON ceds6sc.ref_employed_while_enrolled IS '';

ALTER TABLE ceds6sc.ref_employment_separation_type ADD CONSTRAINT fk_ref_employment_separation_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Employment_Separation_Type_Organization ON ceds6sc.ref_employment_separation_type IS '';

ALTER TABLE ceds6sc.ref_employment_status_while_enrolled ADD CONSTRAINT fk_ref_employment_status_while_enrolled_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Employment_Status_While_Enrolled_Organization ON ceds6sc.ref_employment_status_while_enrolled IS '';

ALTER TABLE ceds6sc.ref_enrollment_status ADD CONSTRAINT fk_ref_enrollment_status_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Enrollment_Status_Organization ON ceds6sc.ref_enrollment_status IS '';

ALTER TABLE ceds6sc.ref_entry_type ADD CONSTRAINT fk_ref_entry_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Entry_Type_Organization ON ceds6sc.ref_entry_type IS '';

ALTER TABLE ceds6sc.ref_exit_or_withdrawal_status ADD CONSTRAINT fk_ref_exit_or_withdrawal_status_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Exit_Or_Withdrawal_Status_Organization ON ceds6sc.ref_exit_or_withdrawal_status IS '';

ALTER TABLE ceds6sc.ref_family_income_source ADD CONSTRAINT fk_ref_family_income_source_org FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Family_Income_Source_Org ON ceds6sc.ref_family_income_source IS '';

ALTER TABLE ceds6sc.ref_financial_account_balance_sheet_code ADD CONSTRAINT fk_ref_financial_balance_sheet_account_code_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Financial_Balance_Sheet_Account_Code_Organization ON ceds6sc.ref_financial_account_balance_sheet_code IS '';

ALTER TABLE ceds6sc.ref_financial_account_fund_classification ADD CONSTRAINT fk_ref_financial_account_fund_classification_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Financial_Account_Fund_Classification_Organization ON ceds6sc.ref_financial_account_fund_classification IS '';

ALTER TABLE ceds6sc.ref_financial_account_revenue_code ADD CONSTRAINT fk_ref_financial_revenue_account_code_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Financial_Revenue_Account_Code_Organization ON ceds6sc.ref_financial_account_revenue_code IS '';

ALTER TABLE ceds6sc.ref_financial_aid_award_status ADD CONSTRAINT fk_ref_financial_aid_award_status_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Financial_Aid_Award_Status_Organization ON ceds6sc.ref_financial_aid_award_status IS '';

ALTER TABLE ceds6sc.ref_financial_aid_veterans_benefit_status ADD CONSTRAINT fk_ref_financial_aid_veterans_benefit_status_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Financial_Aid_Veterans_Benefit_Status_Organization ON ceds6sc.ref_financial_aid_veterans_benefit_status IS '';

ALTER TABLE ceds6sc.ref_financial_expenditure_function_code ADD CONSTRAINT fk_ref_financial_expenditure_function_code_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Financial_Expenditure_Function_Code_Organization ON ceds6sc.ref_financial_expenditure_function_code IS '';

ALTER TABLE ceds6sc.ref_financial_expenditure_object_code ADD CONSTRAINT fk_ref_financial_expenditure_object_code_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Financial_Expenditure_Object_Code_Organization ON ceds6sc.ref_financial_expenditure_object_code IS '';

ALTER TABLE ceds6sc.ref_food_service_eligibility ADD CONSTRAINT fk_ref_food_service_eligibility_organization FOREIGN KEY ( ref_jurisdiction ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Food_Service_Eligibility_Organization ON ceds6sc.ref_food_service_eligibility IS '';

ALTER TABLE ceds6sc.ref_frequency_of_service ADD CONSTRAINT fk_ref_frequency_of_service_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Frequency_Of_Service_Organization ON ceds6sc.ref_frequency_of_service IS '';

ALTER TABLE ceds6sc.ref_goals_for_attending_adult_education ADD CONSTRAINT fk_ref_goals_for_attending_adult_education_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Goals_For_Attending_Adult_Education_Organization ON ceds6sc.ref_goals_for_attending_adult_education IS '';

ALTER TABLE ceds6sc.ref_grade_level ADD CONSTRAINT fk_ref_grade_level_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Grade_Level_Organization ON ceds6sc.ref_grade_level IS '';

ALTER TABLE ceds6sc.ref_grade_level ADD CONSTRAINT fk_ref_grade_level_ref_grade_level_type FOREIGN KEY ( ref_grade_level_type_id ) REFERENCES ceds6sc.ref_grade_level_type( ref_grade_level_type_id );

COMMENT ON CONSTRAINT FK_Ref_Grade_Level_Ref_Grade_Level_Type ON ceds6sc.ref_grade_level IS '';

ALTER TABLE ceds6sc.ref_grade_point_average_domain ADD CONSTRAINT fk_ref_grade_point_average_domain_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Grade_Point_Average_Domain_Organization ON ceds6sc.ref_grade_point_average_domain IS '';

ALTER TABLE ceds6sc.ref_graduate_or_doctoral_exam_results_status ADD CONSTRAINT fk_ref_graduate_or_doctoral_exam_results_status_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Graduate_Or_Doctoral_Exam_Results_Status_Organization ON ceds6sc.ref_graduate_or_doctoral_exam_results_status IS '';

ALTER TABLE ceds6sc.ref_health_insurance_coverage ADD CONSTRAINT fk_ref_insurance_type_org FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Insurance_Type_Org ON ceds6sc.ref_health_insurance_coverage IS '';

ALTER TABLE ceds6sc.ref_high_school_diploma_distinction_type ADD CONSTRAINT fk_ref_hs_diploma_distinction_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Hs_Diploma_Distinction_Type_Organization ON ceds6sc.ref_high_school_diploma_distinction_type IS '';

ALTER TABLE ceds6sc.ref_high_school_graduation_rate_indicator ADD CONSTRAINT fk_ref_hsgraduation_rate_indicator_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_HSGraduation_Rate_Indicator_Organization ON ceds6sc.ref_high_school_graduation_rate_indicator IS '';

ALTER TABLE ceds6sc.ref_homeless_nighttime_residence ADD CONSTRAINT fk_ref_homeless_nighttime_residence_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Homeless_Nighttime_Residence_Organization ON ceds6sc.ref_homeless_nighttime_residence IS '';

ALTER TABLE ceds6sc.ref_idea_educational_environment_ec ADD CONSTRAINT fk_ref_idea_ed_environment_for_ec_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Idea_Ed_Environment_For_EC_Organization ON ceds6sc.ref_idea_educational_environment_ec IS '';

ALTER TABLE ceds6sc.ref_idea_environment_el ADD CONSTRAINT fk_ref_idea_environment_el_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_IDEA_Environment_EL_Organization ON ceds6sc.ref_idea_environment_el IS '';

ALTER TABLE ceds6sc.ref_idea_interim_removal ADD CONSTRAINT fk_ref_idea_interim_removal_id_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Idea_Interim_Removal_Id_Organization ON ceds6sc.ref_idea_interim_removal IS '';

ALTER TABLE ceds6sc.ref_idea_part_c_eligibility_category ADD CONSTRAINT fk_ref_idea_part_c_eligibility_category_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_IDEA_Part_C_Eligibility_Category_Organization ON ceds6sc.ref_idea_part_c_eligibility_category IS '';

ALTER TABLE ceds6sc.ref_iso6393_language ADD CONSTRAINT fk_ref_iso6393_language_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_ISO6393_Language_Organization ON ceds6sc.ref_iso6393_language IS '';

ALTER TABLE ceds6sc.ref_immunization_type ADD CONSTRAINT fk_ref_immunization_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Immunization_Organization ON ceds6sc.ref_immunization_type IS '';

ALTER TABLE ceds6sc.ref_incident_behavior_secondary ADD CONSTRAINT fk_ref_incident_behavior_secondary_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Incident_Behavior_Secondary_Organization ON ceds6sc.ref_incident_behavior_secondary IS '';

ALTER TABLE ceds6sc.ref_incident_location ADD CONSTRAINT fk_ref_incident_location_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Incident_Location_Organization ON ceds6sc.ref_incident_location IS '';

ALTER TABLE ceds6sc.ref_incident_perpetrator_injury_type ADD CONSTRAINT fk_ref_incident_perpetrator_injury_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Incident_Perpetrator_Injury_Type_Organization ON ceds6sc.ref_incident_perpetrator_injury_type IS '';

ALTER TABLE ceds6sc.ref_incident_person_type ADD CONSTRAINT fk_ref_incident_person_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Incident_Person_Type_Organization ON ceds6sc.ref_incident_person_type IS '';

ALTER TABLE ceds6sc.ref_incident_time_description_code ADD CONSTRAINT fk_ref_incident_time_desc_code_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Incident_Time_Desc_Code_Organization ON ceds6sc.ref_incident_time_description_code IS '';

ALTER TABLE ceds6sc.ref_increased_learning_time_type ADD CONSTRAINT fk_ref_increased_learning_time_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Increased_Learning_Time_Type_Organization ON ceds6sc.ref_increased_learning_time_type IS '';

ALTER TABLE ceds6sc.ref_individualized_program_location ADD CONSTRAINT fk_ref_individualized_program_location_org FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Individualized_Program_Location_Org ON ceds6sc.ref_individualized_program_location IS '';

ALTER TABLE ceds6sc.ref_individualized_program_transition_type ADD CONSTRAINT fk_ref_individualized_program_transition_type_org FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Individualized_Program_Transition_Type_Org ON ceds6sc.ref_individualized_program_transition_type IS '';

ALTER TABLE ceds6sc.ref_institution_telephone_type ADD CONSTRAINT fk_ref_institution_telephone_org FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Institution_Telephone_Org ON ceds6sc.ref_institution_telephone_type IS '';

ALTER TABLE ceds6sc.ref_instruction_location_type ADD CONSTRAINT fk_ref_instruction_location_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Instruction_Location_Type_Organization ON ceds6sc.ref_instruction_location_type IS '';

ALTER TABLE ceds6sc.ref_instructional_staff_contract_length ADD CONSTRAINT fk_ref_instruct_staff_contract_length_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Instruct_Staff_Contract_Length_Organization ON ceds6sc.ref_instructional_staff_contract_length IS '';

ALTER TABLE ceds6sc.ref_integrated_technology_status ADD CONSTRAINT fk_ref_integrated_technology_status_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Integrated_Technology_Status_Organization ON ceds6sc.ref_integrated_technology_status IS '';

ALTER TABLE ceds6sc.ref_ipeds_occupational_category ADD CONSTRAINT fk_ref_ipeds_occupational_category_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Ipeds_Occupational_Category_Organization ON ceds6sc.ref_ipeds_occupational_category IS '';

ALTER TABLE ceds6sc.ref_item_response_theory_kappa_algorithm ADD CONSTRAINT fk_ref_irt_kappa_algorithm_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_IRt_Kappa_Algorithm_Organization ON ceds6sc.ref_item_response_theory_kappa_algorithm IS '';

ALTER TABLE ceds6sc.ref_k12_lea_title_i_support_service ADD CONSTRAINT fk_ref_k12_lea_title_i_support_service_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_K12_LEA_Title_I_Support_Service_Organization ON ceds6sc.ref_k12_lea_title_i_support_service IS '';

ALTER TABLE ceds6sc.ref_k12_staff_classification ADD CONSTRAINT fk_ref_education_staff_classification_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Education_Staff_Classification_Organization ON ceds6sc.ref_k12_staff_classification IS '';

ALTER TABLE ceds6sc.ref_language_use_type ADD CONSTRAINT fk_ref_language_use_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Language_Use_Type_Organization ON ceds6sc.ref_language_use_type IS '';

ALTER TABLE ceds6sc.ref_lea_improvement_status ADD CONSTRAINT fk_ref_lea_improvement_status_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_LEA_Improvement_Status_Organization ON ceds6sc.ref_lea_improvement_status IS '';

ALTER TABLE ceds6sc.ref_learner_action_type ADD CONSTRAINT fk_ref_learner_action_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Learner_Action_Type_Organization ON ceds6sc.ref_learner_action_type IS '';

ALTER TABLE ceds6sc.ref_learner_activity_type ADD CONSTRAINT fk_ref_learner_activity_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Learner_Activity_Type_Organization ON ceds6sc.ref_learner_activity_type IS '';

ALTER TABLE ceds6sc.ref_learning_resource_access_hazard_type ADD CONSTRAINT fk_ref_learning_resource_access_hazard_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Learning_Resource_Access_Hazard_Type_Organization ON ceds6sc.ref_learning_resource_access_hazard_type IS '';

ALTER TABLE ceds6sc.ref_learning_resource_access_rights_url ADD CONSTRAINT fk_ref_learning_resource_access_rights_url_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Learning_Resource_Access_Rights_Url_Organization ON ceds6sc.ref_learning_resource_access_rights_url IS '';

ALTER TABLE ceds6sc.ref_learning_resource_book_format_type ADD CONSTRAINT fk_ref_learning_resource_book_format_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Learning_Resource_Book_Format_Type_Organization ON ceds6sc.ref_learning_resource_book_format_type IS '';

ALTER TABLE ceds6sc.ref_learning_resource_control_flexibility_type ADD CONSTRAINT fk_ref_learning_resource_control_flexibility_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Learning_Resource_Control_Flexibility_Type_Organization ON ceds6sc.ref_learning_resource_control_flexibility_type IS '';

ALTER TABLE ceds6sc.ref_learning_resource_digital_media_type ADD CONSTRAINT fk_ref_learning_resource_digital_media_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Learning_Resource_Digital_Media_Type_Organization ON ceds6sc.ref_learning_resource_digital_media_type IS '';

ALTER TABLE ceds6sc.ref_learning_resource_intended_end_user_role ADD CONSTRAINT fk_ref_lr_intended_end_user_role_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_LR_Intended_End_User_Role_Organization ON ceds6sc.ref_learning_resource_intended_end_user_role IS '';

ALTER TABLE ceds6sc.ref_learning_resource_interactivity_type ADD CONSTRAINT fk_ref_lr_interactivity_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_LR_Interactivity_Type_Organization ON ceds6sc.ref_learning_resource_interactivity_type IS '';

ALTER TABLE ceds6sc.ref_learning_resource_physical_media_type ADD CONSTRAINT fk_ref_learning_resource_physical_media_type_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Learning_Resource_Physical_Media_Type_Organization ON ceds6sc.ref_learning_resource_physical_media_type IS '';

ALTER TABLE ceds6sc.ref_learning_standard_document_publication_status ADD CONSTRAINT fk_ref_ls_document_publication_status_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_LS_Document_Publication_Status_Organization ON ceds6sc.ref_learning_standard_document_publication_status IS '';

ALTER TABLE ceds6sc.ref_learning_standard_item_node_accessibility_profile ADD CONSTRAINT fk_ref_learning_standard_item_node_accessibility_profile_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Learning_Standard_Item_Node_Accessibility_Profile_Organization ON ceds6sc.ref_learning_standard_item_node_accessibility_profile IS '';
...
ALTER TABLE ceds6sc.ref_pre_kindergarten__eligibility ADD CONSTRAINT fk_ref_pre_kindergarten__eligibility_organization FOREIGN KEY ( ref_jurisdiction_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT FK_Ref_Pre_Kindergarten__Eligibility_Organization ON ceds6sc.ref_pre_kindergarten__eligibility IS '';
...
ALTER TABLE ceds6sc.assessment_el_developmental_domain ADD CONSTRAINT fk_assessment_assessment_el_developmental_domain_assessment FOREIGN KEY ( assessment_id ) REFERENCES ceds6sc.assessment( assessment_id );

COMMENT ON CONSTRAINT fk_assessment_assessment_el_developmental_domain_assessment ON ceds6sc.assessment_el_developmental_domain IS '';

ALTER TABLE ceds6sc.assessment_el_developmental_domain ADD CONSTRAINT fk_assessment_assessment_el_developmental_domain_ref_assessment_el_developmental_domain FOREIGN KEY ( ref_assessment_el_developmental_domain_id ) REFERENCES ceds6sc.ref_assessment_el_developmental_domain( ref_assessment_el_developmental_domain_id );

COMMENT ON CONSTRAINT fk_assessment_assessment_el_developmental_domain_ref_assessment_el_developmental_domain ON ceds6sc.assessment_el_developmental_domain IS '';
...
ALTER TABLE ceds6sc.assessment_registration ADD CONSTRAINT fk_assessment_regirstration_ref_assessment_form FOREIGN KEY ( assessment_form_id ) REFERENCES ceds6sc.assessment_form( assessment_form_id );

COMMENT ON CONSTRAINT fk_assessment_regirstration_ref_assessment_form ON ceds6sc.assessment_registration IS '';
...
ALTER TABLE ceds6sc.assessment_registration ADD CONSTRAINT fk_assessment_registration_ref_organization1 FOREIGN KEY ( school_organization_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT fk_assessment_registration_ref_organization1 ON ceds6sc.assessment_registration IS '';

ALTER TABLE ceds6sc.assessment_registration ADD CONSTRAINT fk_assessment_registration_ref_organization2 FOREIGN KEY ( lea_organization_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT fk_assessment_registration_ref_organization2 ON ceds6sc.assessment_registration IS '';
...
ALTER TABLE ceds6sc.assessment_registration ADD CONSTRAINT fk_assessment_registration_person2 FOREIGN KEY ( person_id ) REFERENCES ceds6sc.person( person_id );

COMMENT ON CONSTRAINT fk_assessment_registration_person2 ON ceds6sc.assessment_registration IS '';
...
ALTER TABLE ceds6sc.assessment_registration ADD CONSTRAINT fk_assessment_registration_ref_grade_level1 FOREIGN KEY ( ref_grade_level_to_be_assessed_id ) REFERENCES ceds6sc.ref_grade_level( ref_grade_level_id );

COMMENT ON CONSTRAINT fk_assessment_registration_ref_grade_level1 ON ceds6sc.assessment_registration IS '';
