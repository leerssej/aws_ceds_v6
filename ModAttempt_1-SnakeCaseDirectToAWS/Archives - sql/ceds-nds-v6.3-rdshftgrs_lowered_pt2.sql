...
CREATE TABLE ceds6sc.assessment_item_apip ( 
	...
	response_processing_xml xml  ,
	response_declaration_xml xml  ,
	outcome_declaration_xml xml  ,
	template_declaration_xml xml  ,
	template_processing_xml xml  ,
	modal_feedback_xml   xml  ,
	item_body_xml        xml  ,
...
CREATE TABLE ceds6sc.person_health ( 
	...
	health_screening_follow_up_recommendation xml  ,
...
CREATE TABLE ceds6sc.person_telephone ( 
	...
	primary_telephone_number_indicator bool DEFAULT 0 NOT NULL,
...
ALTER TABLE ceds6sc.assessment_participant_session_accommodation ADD CONSTRAINT fk_assess_part_session_accommodation _ref_assessment_accommodation_category FOREIGN KEY ( ref_assessment_accommodation_category_id ) REFERENCES ceds6sc.ref_assessment_accommodation_category( ref_assessment_accommodation_category_id );

COMMENT ON CONSTRAINT FK_Assess_Part_Session_Accommodation _Ref_Assessment_Accommodation_Category ON ceds6sc.assessment_participant_session_accommodation IS '';
...
ALTER TABLE ceds6sc.assessment_registration_accommodation ADD CONSTRAINT fk_assess_reg_accommodation _ref_assessment_accommodation_category FOREIGN KEY ( ref_assessment_accommodation_category_id ) REFERENCES ceds6sc.ref_assessment_accommodation_category( ref_assessment_accommodation_category_id );

COMMENT ON CONSTRAINT FK_Assess_Reg_Accommodation _Ref_Assessment_Accommodation_Category ON ceds6sc.assessment_registration_accommodation IS '';
...
ALTER TABLE ceds6sc.course_section ADD CONSTRAINT fk_course_section_organization FOREIGN KEY ( organization_id ) REFERENCES ceds6sc.organization( organization_id ) ON DEL_ETE CASCADE ON UPD_ATE CASCADE;
...
ALTER TABLE ceds6sc.el_child_outcome_summary ADD CONSTRAINT fk_el_child_outcome_summary_cos_rating_c FOREIGN KEY ( cos_rating_cid ) REFERENCES ceds6sc.ref_child_outcomes_summary_rating( ref_child_outcomes_summary_rating_id );
...
ALTER TABLE ceds6sc.k12_sea ADD CONSTRAINT fk_k12_sea_organization FOREIGN KEY ( organization_id ) REFERENCES ceds6sc.organization( organization_id ) ON DEL_ETE CASCADE ON UPD_ATE CASCADE;
...
ALTER TABLE ceds6sc.k12_staff_assignment ADD CONSTRAINT fk_k12_staff_assignment_organization_person FOREIGN KEY ( organization_person_role_id ) REFERENCES ceds6sc.organization_person_role( organization_person_role_id ) ON DEL_ETE CASCADE ON UPD_ATE CASCADE;
...
ALTER TABLE ceds6sc.k12_student_course_section ADD CONSTRAINT fk_k12_student_course_section_organization_person FOREIGN KEY ( organization_person_role_id ) REFERENCES ceds6sc.organization_person_role( organization_person_role_id ) ON DEL_ETE CASCADE ON UPD_ATE CASCADE;
...
ALTER TABLE ceds6sc.k12_student_course_section ADD CONSTRAINT fk_k12_student_course_section _ref_course_gpa_applicability FOREIGN KEY ( ref_course_gpa_applicability_id ) REFERENCES ceds6sc.ref_course_gpa_applicability( ref_course_gpa_applicability_id );

COMMENT ON CONSTRAINT FK_K12_Student_Course_Section _Ref_Course_Gpa_Applicability ON ceds6sc.k12_student_course_section IS '';
...
ALTER TABLE ceds6sc.k12_student_discipline ADD CONSTRAINT fk_k12_student_discipline_organization_person FOREIGN KEY ( organization_person_role_id ) REFERENCES ceds6sc.organization_person_role( organization_person_role_id ) ON DEL_ETE CASCADE ON UPD_ATE CASCADE;
...
ALTER TABLE ceds6sc.k12_student_enrollment ADD CONSTRAINT fk_k12_enrollment_member_organization_person FOREIGN KEY ( organization_person_role_id ) REFERENCES ceds6sc.organization_person_role( organization_person_role_id ) ON DEL_ETE CASCADE ON UPD_ATE CASCADE;
...
ALTER TABLE ceds6sc.location_address ADD CONSTRAINT fk_location_address_location FOREIGN KEY ( location_id ) REFERENCES ceds6sc.location( location_id ) ON DEL_ETE CASCADE ON UPD_ATE CASCADE;
...
ALTER TABLE ceds6sc.ps_section ADD CONSTRAINT fk_ps_section _ref_course_gpa_applicability FOREIGN KEY ( ref_course_gpa_applicability_id ) REFERENCES ceds6sc.ref_course_gpa_applicability( ref_course_gpa_applicability_id );

COMMENT ON CONSTRAINT FK_Ps_Section _Ref_Course_Gpa_Applicability ON ceds6sc.ps_section IS '';

ALTER TABLE ceds6sc.ps_section ADD CONSTRAINT fk_ps_section _ref_course_honors_type FOREIGN KEY ( ref_course_honors_type_id ) REFERENCES ceds6sc.ref_course_honors_type( ref_course_honors_type_id );

COMMENT ON CONSTRAINT FK_Ps_Section _Ref_Course_Honors_Type ON ceds6sc.ps_section IS '';

ALTER TABLE ceds6sc.ps_section ADD CONSTRAINT fk_ps_section _ref_course_instruction_method FOREIGN KEY ( ref_course_instruction_method_id ) REFERENCES ceds6sc.ref_course_instruction_method( ref_course_instruction_method_id );

COMMENT ON CONSTRAINT FK_Ps_Section _Ref_Course_Instruction_Method ON ceds6sc.ps_section IS '';

ALTER TABLE ceds6sc.ps_section ADD CONSTRAINT fk_ps_section _ref_course_level_type FOREIGN KEY ( ref_course_level_type_id ) REFERENCES ceds6sc.ref_course_level_type( ref_course_level_type_id );

COMMENT ON CONSTRAINT FK_Ps_Section _Ref_Course_Level_Type ON ceds6sc.ps_section IS '';
...
ALTER TABLE ceds6sc.ps_student_financial_aid ADD CONSTRAINT fk_ps_student_financial_aid_ref_financial_aid_veterans_benefit_status FOREIGN KEY ( ref_financial_aid_veterans_benefit_status_id ) REFERENCES ceds6sc.ref_financial_aid_veterans_benefit_status( ref_financial_aid_veterans_benefit_status_id );

COMMENT ON CONSTRAINT FK_Ps_Student_Financial_Aid_Ref_Financial_Aid_Veterans_Benefit_Status ON ceds6sc.ps_student_financial_aid IS '';

ALTER TABLE ceds6sc.ps_student_financial_aid ADD CONSTRAINT fk_ps_student_financial_aid_ref_financial_aid_veterans_benefit_type FOREIGN KEY ( ref_financial_aid_veterans_benefit_type_id ) REFERENCES ceds6sc.ref_financial_aid_veterans_benefit_type( ref_financial_aid_veterans_benefit_type_id );

COMMENT ON CONSTRAINT FK_Ps_Student_Financial_Aid_Ref_Financial_Aid_Veterans_Benefit_Type ON ceds6sc.ps_student_financial_aid IS '';
...
ALTER TABLE ceds6sc.ref_organization_identification_system ADD CONSTRAINT fk_ref_org_identification_system _ref_organization_identifier_type FOREIGN KEY ( ref_organization_identifier_type_id ) REFERENCES ceds6sc.ref_organization_identifier_type( ref_organization_identifier_type_id );

COMMENT ON CONSTRAINT FK_Ref_Org_Identification_System _Ref_Organization_Identifier_Type ON ceds6sc.ref_organization_identification_system IS '';
...
ALTER TABLE ceds6sc.ref_person_identification_system ADD CONSTRAINT fk_ref_person_identification_system _ref_person_identifier_type FOREIGN KEY ( ref_person_identifier_type_id ) REFERENCES ceds6sc.ref_person_identifier_type( ref_person_identifier_type_id );

COMMENT ON CONSTRAINT FK_Ref_Person_Identification_System _Ref_Person_Identifier_Type ON ceds6sc.ref_person_identification_system IS '';
...
ALTER TABLE ceds6sc.el_enrollment ADD CONSTRAINT fk_ec_program_enrollment_organization_person FOREIGN KEY ( organization_person_role_id ) REFERENCES ceds6sc.organization_person_role( organization_person_role_id ) ON DEL_ETE CASCADE ON UPD_ATE CASCADE;
...
ALTER TABLE ceds6sc.k12_lea ADD CONSTRAINT fk_k12_lea_organization FOREIGN KEY ( organization_id ) REFERENCES ceds6sc.organization( organization_id ) ON DEL_ETE CASCADE ON UPD_ATE CASCADE;
...
ALTER TABLE ceds6sc.k12_school ADD CONSTRAINT fk_k12_school_organization FOREIGN KEY ( organization_id ) REFERENCES ceds6sc.organization( organization_id ) ON DEL_ETE CASCADE ON UPD_ATE CASCADE;
...
ALTER TABLE ceds6sc.k12_student_academic_record ADD CONSTRAINT fk_k12_student_academic_record_organization_person FOREIGN KEY ( organization_person_role_id ) REFERENCES ceds6sc.organization_person_role( organization_person_role_id ) ON DEL_ETE CASCADE ON UPD_ATE CASCADE;
...
ALTER TABLE ceds6sc.organization_federal_accountability ADD CONSTRAINT fk_organization_federal_accountability_organization FOREIGN KEY ( organization_id ) REFERENCES ceds6sc.organization( organization_id );

COMMENT ON CONSTRAINT fk_organization_federal_accountability_organization ON ceds6sc.organization_federal_accountability IS '';

ALTER TABLE ceds6sc.organization_federal_accountability ADD CONSTRAINT fk_organization_fed_accountability_ref_amao_attainment_lep_students FOREIGN KEY ( amao_ayp_progress_attainment_lep_students ) REFERENCES ceds6sc.ref_amao_attainment_status( ref_amao_attainment_status_id );

COMMENT ON CONSTRAINT fk_organization_fed_accountability_ref_amao_attainment_lep_students ON ceds6sc.organization_federal_accountability IS '';

ALTER TABLE ceds6sc.organization_federal_accountability ADD CONSTRAINT fk_organization_fed_accountability_ref_amao_attainment_lep_students_1 FOREIGN KEY ( amao_proficiency_attainment_lep_students ) REFERENCES ceds6sc.ref_amao_attainment_status( ref_amao_attainment_status_id );

COMMENT ON CONSTRAINT fk_organization_fed_accountability_ref_amao_attainment_lep_students_1 ON ceds6sc.organization_federal_accountability IS '';

ALTER TABLE ceds6sc.organization_federal_accountability ADD CONSTRAINT fk_organization_fed_accountability_ref_amao_attainment_lep_students_2 FOREIGN KEY ( amao_progress_attainment_lep_students ) REFERENCES ceds6sc.ref_amao_attainment_status( ref_amao_attainment_status_id );

COMMENT ON CONSTRAINT fk_organization_fed_accountability_ref_amao_attainment_lep_students_2 ON ceds6sc.organization_federal_accountability IS '';

ALTER TABLE ceds6sc.organization_federal_accountability ADD CONSTRAINT fk_organization_federa_accountability_ref_ayp_status FOREIGN KEY ( ref_ayp_status_id ) REFERENCES ceds6sc.ref_ayp_status( ref_ayp_status_id );

COMMENT ON CONSTRAINT fk_organization_federa_accountability_ref_ayp_status ON ceds6sc.organization_federal_accountability IS '';

ALTER TABLE ceds6sc.organization_federal_accountability ADD CONSTRAINT fk_organization_fed_accountability_ref_ctegraduation_rate_inclusion FOREIGN KEY ( ref_cte_graduation_rate_inclusion_id ) REFERENCES ceds6sc.ref_cte_graduation_rate_inclusion( ref_cte_graduation_rate_inclusion_id );

COMMENT ON CONSTRAINT fk_organization_fed_accountability_ref_ctegraduation_rate_inclusion ON ceds6sc.organization_federal_accountability IS '';

ALTER TABLE ceds6sc.organization_federal_accountability ADD CONSTRAINT fk_organization_fed_accountability_ref_elementary_middle_additional FOREIGN KEY ( ref_elementary_middle_additional_id ) REFERENCES ceds6sc.ref_elementary_middle_additional( ref_elementary_middle_additional_id );

COMMENT ON CONSTRAINT fk_organization_fed_accountability_ref_elementary_middle_additional ON ceds6sc.organization_federal_accountability IS '';

ALTER TABLE ceds6sc.organization_federal_accountability ADD CONSTRAINT fk_organization_federal_accountability_ref_gun_free_schools_act_status FOREIGN KEY ( ref_gun_free_schools_act_status_reporting_id ) REFERENCES ceds6sc.ref_gun_free_schools_act_reporting_status( ref_gun_free_schools_act_status_reporting_id );

COMMENT ON CONSTRAINT fk_organization_federal_accountability_ref_gun_free_schools_act_status ON ceds6sc.organization_federal_accountability IS '';

ALTER TABLE ceds6sc.organization_federal_accountability ADD CONSTRAINT fk_organization_fed_accountability_ref_hsgraduation_rate_indicator FOREIGN KEY ( ref_high_school_graduation_rate_indicator ) REFERENCES ceds6sc.ref_high_school_graduation_rate_indicator( ref_hsgraduation_rate_indicator_id );

COMMENT ON CONSTRAINT fk_organization_fed_accountability_ref_hsgraduation_rate_indicator ON ceds6sc.organization_federal_accountability IS '';

ALTER TABLE ceds6sc.organization_federal_accountability ADD CONSTRAINT fk_organization_federal_accountability_ref_participation_status_ayp_2 FOREIGN KEY ( ref_participation_status_math_id ) REFERENCES ceds6sc.ref_participation_status_ayp( ref_participation_status_ayp_id );

COMMENT ON CONSTRAINT fk_organization_federal_accountability_ref_participation_status_ayp_2 ON ceds6sc.organization_federal_accountability IS '';

ALTER TABLE ceds6sc.organization_federal_accountability ADD CONSTRAINT fk_organization_federal_accountability_ref_participation_status_ayp_3 FOREIGN KEY ( ref_participation_status_rla_id ) REFERENCES ceds6sc.ref_participation_status_ayp( ref_participation_status_ayp_id );

COMMENT ON CONSTRAINT fk_organization_federal_accountability_ref_participation_status_ayp_3 ON ceds6sc.organization_federal_accountability IS '';

ALTER TABLE ceds6sc.organization_federal_accountability ADD CONSTRAINT fk_organization_federal_accountability_ref_proficiency_target_ayp FOREIGN KEY ( ref_proficiency_target_status_math_id ) REFERENCES ceds6sc.ref_proficiency_target_ayp( ref_proficiency_target_ayp_id );

COMMENT ON CONSTRAINT fk_organization_federal_accountability_ref_proficiency_target_ayp ON ceds6sc.organization_federal_accountability IS '';

ALTER TABLE ceds6sc.organization_federal_accountability ADD CONSTRAINT fk_organization_federal_accountability_ref_proficiency_target_ayp_1 FOREIGN KEY ( ref_proficiency_target_status_rlaid ) REFERENCES ceds6sc.ref_proficiency_target_ayp( ref_proficiency_target_ayp_id );

COMMENT ON CONSTRAINT fk_organization_federal_accountability_ref_proficiency_target_ayp_1 ON ceds6sc.organization_federal_accountability IS '';

ALTER TABLE ceds6sc.organization_federal_accountability ADD CONSTRAINT fk_organization_federal_accountability_ref_reconstituted_status FOREIGN KEY ( ref_reconstituted_status_id ) REFERENCES ceds6sc.ref_reconstituted_status( ref_reconstituted_status_id );

COMMENT ON CONSTRAINT fk_organization_federal_accountability_ref_reconstituted_status ON ceds6sc.organization_federal_accountability IS '';
...
ALTER TABLE ceds6sc.ps_institution ADD CONSTRAINT fk_ps_institution_organization FOREIGN KEY ( organization_id ) REFERENCES ceds6sc.organization( organization_id ) ON DEL_ETE CASCADE ON UPD_ATE CASCADE;
