...
USE [master];
/****** Object:  Database [CEDS_TSQL_v6sc_redux]  ******/
CREATE DATABASE [CEDS_TSQL_v6sc_redux];
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET COMPATIBILITY_LEVEL = 100;

IF (1 = FULLTEXTSERVICEPROPERTY('Is_Full_Text_Installed'))
begin
EXEC [CEDS_TSQL_v6sc_redux].[dbo].[sp_fulltext_database] @action = 'enable'
end;

ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET ANSI_NULL_DEFAULT OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET ANSI_NULLS OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET ANSI_PADDING OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET ANSI_WARNINGS OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET ARITHABORT OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET AUTO_CLOSE OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET AUTO_CREATE_STATISTICS ON ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET AUTO_SHRINK OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET AUTO_UPDATE_STATISTICS ON ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET CURSOR_CLOSE_ON_COMMIT OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET CURSOR_DEFAULT  GLOBAL ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET CONCAT_NULL_YIELDS_NULL OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET NUMERIC_ROUNDABORT OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET QUOTED_IDENTIFIER OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET RECURSIVE_TRIGGERS OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET  ENABLE_BROKER ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET AUTO_UPDATE_STATISTICS_ASYNC OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET DATE_CORRELATION_OPTIMIZATION OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET TRUSTWORTHY OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET ALLOW_SNAPSHOT_ISOLATION OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET PARAMETERIZATION SIMPLE ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET READ_COMMITTED_SNAPSHOT OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET HONOR_BROKER_PRIORITY OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET  READ_WRITE ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET RECOVERY FULL ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET  MULTI_USER ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET PAGE_VERIFY CHECKSUM  ;
ALTER DATABASE [CEDS_TSQL_v6sc_redux] SET DB_CHAINING OFF ;


USE [CEDS_TSQL_v6sc_redux];
...
CREATE TABLE [dbo].[Achievement](
	...
	[Category_System] [nvarchar](50) NULL,
	[Image_Url] [nvarchar](300) NULL,
	[Criteria] [nvarchar](300) NULL,
	[Criteria_Url] [nvarchar](300) NULL,
	[Competency_Set_Id] [int] NULL,
	[Start_Date] [date] NULL,
	[End_Date] [date] NULL,
	[Award_Issuer_Name] [nvarchar](128) NULL,
	[Award_Issuer_Origin_URL] [nvarchar](300) NULL,
...
;
/****** Object:  Table [dbo].[Achievement_Evidence]  ******/
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
CREATE TABLE [dbo].[Achievement_Evidence](
	[Achievement_Evidence_Id] [int] IDENTITY(1,1) NOT NULL,
	[Achievement_Id] [int] NULL,
	[Statement] [nvarchar](300) NULL,
	[Assessment_Subtest_Result_Id] [int] NULL,
 CONSTRAINT [PK_Achievement_Evidence] PRIMARY KEY CLUSTERED 
(
	[Achievement_Evidence_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
;
...
CREATE TABLE [dbo].[Assessment_Item_Apip](
	[Assessment_Item_Id] [int] NOT NULL,
	[Adaptive_Indicator] [bit] NULL,
	[Response_Processing_Template_Url] [nvarchar](300) NULL,
...
CREATE TABLE [dbo].[Assessment_Need_Apip_Display](
	...
	[Encouragement_Sound_File_Url] [nvarchar](300) NULL,
...
CREATE TABLE [dbo].[Assessment_Participant_Session_Accommodation](
	...
	[Assessment_Participant_Session_Id] [int] NOT NULL,
	[Ref_Assessment_Accommodation_Type_Id] [int] NOT NULL,
...
(
 ...
 CONSTRAINT [IX_Assessment_Participant_Session_Accomodation] UNIQUE NONCLUSTERED 
(
	[Assessment_Participant_Session_Id] ASC,
	[Ref_Assessment_Accommodation_Type_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
;
...
(
 ...
 CONSTRAINT [IX_Assessment_Registration_Accommodation] UNIQUE NONCLUSTERED 
(
	[Assessment_Registration_Id] ASC,
	[Ref_Assessment_Accommodation_Type_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
;
/****** Object:  Table [dbo].[Assessment_Subtest_Learning_Standard_Item]  ******/
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
CREATE TABLE [dbo].[Assessment_Subtest_Learning_Standard_Item](
	[Assessment_Sub_Test_Learning_Standard_Item_Id] [int] IDENTITY(1,1) NOT NULL,
	[Assessment_Subtest_Id] [int] NOT NULL,
	[Learning_Standard_Item_Id] [int] NOT NULL,
 CONSTRAINT [PK_Assessment_Subtest_Learning_Standard_Item] PRIMARY KEY CLUSTERED 
(
	[Assessment_Sub_Test_Learning_Standard_Item_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
 CONSTRAINT [IX_Assessment_Subtest_Learning_Standard_Item] UNIQUE NONCLUSTERED 
(
	[Assessment_Subtest_Id] ASC,
	[Learning_Standard_Item_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
;
...
CREATE TABLE [dbo].[Authentication](
	...
	[Identity_Provider_Uri] [nvarchar](300) NULL,
...
(
 ...
 CONSTRAINT [IX_Competency_Item_Competency_Set] UNIQUE NONCLUSTERED 
(
	[Learning_Standard_Item_Id] ASC,
...
CREATE TABLE [dbo].[Course_Section](
	...
	[Related_Learning_Standards] [nvarchar](60) NULL,
...
CREATE TABLE [dbo].[EL_Child_Transition_Plan](
	[Person_Id] [int] NOT NULL,
	[Part_B619Potential_Eligibility_Ind] [bit] NULL,
...
CREATE TABLE [dbo].[EL_Enrollment](
 ...
 CONSTRAINT [XPK_ECEnrollment] PRIMARY KEY CLUSTERED 
(
	[Organization_Person_Role_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [dbo].[EL_Organization_Availability](
	[Organization_Id] [int] NOT NULL,
	[Days_Available_Per_Week] [int] NULL,
	[Hours_Available_Per_Day] [int] NULL,
	[Youngest_Age_Served] [int] NULL,
	[Oldest_Age_Served] [int] NULL,
...
CREATE TABLE [dbo].[EL_Staff_Education](
	[Organization_Person_Role_Id] [int] NOT NULL,
	[ECDegree_Or_Certificate_Holder] [bit] NULL,
	[Total_College_Credits_Earned] [decimal](10, 2) NULL,
	[Ref_EL_Level_Of_Specialization_Id] [int] NULL,
	[Total_Approved_ECCredits_Earned] [decimal](10, 2) NULL,
...
CREATE TABLE [dbo].[K12_Lea](
 ...
 CONSTRAINT [XPK_K12Lea] PRIMARY KEY CLUSTERED 
(
	[Organization_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [dbo].[K12_Lea_Federal_Funds](
	...
	[Ses_School_Choice20Percent_Obligation] [numeric](12, 2) NULL,
...
CREATE TABLE [dbo].[K12_Lea_Pre_K_Eligibility](
	...
	[Organization_Id] [int] NOT NULL,
	[Ref_Pre_Kindergarten__Eligibility_Id] [int] NOT NULL,
...
(
	[Organization_Id] ASC,
	[Ref_Pre_Kindergarten__Eligibility_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
;
...
CREATE TABLE [dbo].[K12_Lea_Safe_Drug_Free](
 ...
 CONSTRAINT [XPK_K12School_Safe_Drug_Free] PRIMARY KEY CLUSTERED 
(
	[Organization_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [dbo].[K12_Program_Or_Service](
	[Organization_Id] [int] NOT NULL,
	[Ref_Pre_Kindergarten__Daily_Length_Id] [int] NULL,
...
CREATE TABLE [dbo].[K12_School](
 ...
 CONSTRAINT [XPK_K12School] PRIMARY KEY CLUSTERED 
(
	[Organization_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [dbo].[K12_School_Improvement](
 ...
 CONSTRAINT [XPK_K12School_Improvement] PRIMARY KEY CLUSTERED 
(
...
CREATE TABLE [dbo].[K12_Sea](
 ...
 CONSTRAINT [XPK_K12Sea] PRIMARY KEY CLUSTERED 
(
	[Organization_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [dbo].[K12_Student_Enrollment](
	...
	[First_Entry_Date_Into_USSchool] [date] NULL,
	[Ref_Directory_Information_Block_Status_Id] [int] NULL,
	[NSLPDirect_Certification_Indicator] [bit] NULL,
 CONSTRAINT [XPK_K12Enrollment_Member] PRIMARY KEY CLUSTERED 
(
	[Organization_Person_Role_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
;
/****** Object:  Table [dbo].[Learning_Goal]  ******/
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
CREATE TABLE [dbo].[Learning_Goal](
	[Learning_Goal_Id] [int] IDENTITY(1,1) NOT NULL,
	[Description] [nvarchar](300) NULL,
	...
	[Person_Id] [int] NULL,
	[Competency_Set_Id] [int] NULL,
 CONSTRAINT [PK_Learning_Goal] PRIMARY KEY CLUSTERED 
(
	[Learning_Goal_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
;
...
CREATE TABLE [dbo].[Learning_Resource](
	...
	[Learning_Resource_License_URL] [nvarchar](300) NULL,
	[Based_On_Url] [nvarchar](300) NULL,
	...
	[Adapted_From_URL] [nvarchar](300) NULL,
	...
	[Learning_Resource_Author_URL] [nvarchar](300) NULL,
	[Learning_Resource_Date_Modified] [date] NULL,
	[Learning_Resource_Publisher_Email] [nvarchar](128) NULL,
	[Learning_Resource_Publisher_URL] [nvarchar](300) NULL,
...
CREATE TABLE [dbo].[Learning_Resource_Adaptation](
	...
	[Learning_Resource_Id] [int] NOT NULL,
	[Adaptation_URL] [nvarchar](300) NOT NULL,
...
;
/****** Object:  Table [dbo].[Learning_Standard_Document]  ******/
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
CREATE TABLE [dbo].[Learning_Standard_Document](
	[Learning_Standard_Document_Id] [int] IDENTITY(1,1) NOT NULL,
	[URI] [nvarchar](300) NULL,
	...
	[Ref_Learning_Standard_Document_Publication_Status_Id] [int] NULL,
	...
	[Learning_Standard_Document_Publication_Date] [date] NULL,
 CONSTRAINT [PK_Learning_Standard_Document] PRIMARY KEY CLUSTERED 
(
	[Learning_Standard_Document_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
;
/****** Object:  Table [dbo].[Learning_Standard_Item]  ******/
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
CREATE TABLE [dbo].[Learning_Standard_Item](
	[Learning_Standard_Item_Id] [int] IDENTITY(1,1) NOT NULL,
	[Identifier] [nvarchar](40) NULL,
	[Code] [nvarchar](30) NULL,
	[URL] [nvarchar](300) NULL,
	...
	[Learning_Standard_Item_Parent_Id] [nvarchar](40) NULL,
	[Learning_Standard_Item_Parent_Code] [nvarchar](30) NULL,
	[Learning_Standard_Item_Parent_URL] [nvarchar](300) NULL,
	[Child_Of_Learning_Standard_Item] [int] NULL,
	[Learning_Standard_Document_Id] [int] NOT NULL,
	...
	[Ref_Learning_Standard_Item_Node_Accessibility_Profile_Id] [int] NULL,
	[Ref_Learning_Standard_Item_Testability_Type_Id] [int] NULL,
	[Learning_Standard_Item_Sequence] [nvarchar](60) NULL,
 CONSTRAINT [XPK_Learning_Standard_Item] PRIMARY KEY CLUSTERED 
(
	[Learning_Standard_Item_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
;
/****** Object:  Table [dbo].[Learning_Standard_Item_Association]  ******/
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
CREATE TABLE [dbo].[Learning_Standard_Item_Association](
	[Learning_Standard_Item_Association_Id] [int] IDENTITY(1,1) NOT NULL,
	[Learning_Standard_Item_Id] [int] NOT NULL,
	[Ref_Entity_Type_Id] [int] NOT NULL,
	[Associated_Entity_Id] [int] NOT NULL,
	[Ref_Learning_Standard_Item_Association_Type_Id] [int] NULL,
	[Learning_Standard_Item_Association_Identifier_URI] [nvarchar](300) NULL,
	[Connection_Citation] [nvarchar](300) NULL,
	[Origin_Node_Name] [nvarchar](30) NULL,
	[Origin_Node_URI] [nvarchar](300) NULL,
	[Destination_Node_Name] [nvarchar](30) NULL,
	[Destination_Node_URI] [nvarchar](300) NULL,
	[Weight] [decimal](9, 3) NULL,
 CONSTRAINT [PK_Learning_Standard_Item_Association] PRIMARY KEY CLUSTERED 
(
	[Learning_Standard_Item_Association_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
;
/****** Object:  Table [dbo].[Learning_Standard_Item_Education_Level]  ******/
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
CREATE TABLE [dbo].[Learning_Standard_Item_Education_Level](
	[Learning_Standard_Item_Education_Level_Id] [int] IDENTITY(1,1) NOT NULL,
	[Learning_Standards_Item_Id] [int] NOT NULL,
	[Ref_Education_Level_Id] [int] NOT NULL,
 CONSTRAINT [PK_Learning_Standard_Item_Education_Level] PRIMARY KEY CLUSTERED 
(
	[Learning_Standard_Item_Education_Level_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
 CONSTRAINT [IX_Learning_Standard_Item_Education_Level] UNIQUE NONCLUSTERED 
(
	[Learning_Standards_Item_Id] ASC,
	[Ref_Education_Level_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
;
...
CREATE TABLE [dbo].[Organization_Federal_Accountability](
	...
	[Ref_Proficiency_Target_Status_RLAId] [int] NULL,
...
CREATE TABLE [dbo].[Program_Participation_Special_Education](
	...
	[Ref_IDEA_Educational_Environment_ECId] [int] NULL,
...
;
/****** Object:  Table [dbo].[Program_Participation_Title_I_]  ******/
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
CREATE TABLE [dbo].[Program_Participation_Title_I_](
	[Organization_Person_Role_Id] [int] NOT NULL,
	[Ref_Title_I_Indicator_Id] [int] NULL,
 CONSTRAINT [PK_Program_Participation_Title_I_] PRIMARY KEY CLUSTERED 
(
	[Organization_Person_Role_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [dbo].[Program_Participation_Title_III_Lep](
 ...
 CONSTRAINT [PK_Program_Participation_Title_III_] PRIMARY KEY CLUSTERED 
(
	[Organization_Person_Role_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [dbo].[Ps_Price_Of_Attendance](
	...
	[IPEDSCollection_Year_Designator] [nchar](9) NULL,
...
CREATE TABLE [dbo].[Ps_Program](
	...
	[Ref_DQPCategories_Of_Learning_Id] [int] NULL,
...
CREATE TABLE [dbo].[Ps_Student_Application](
	...
	[Grade_Point_Average_Cumulative] [decimal](9, 2) NULL,
...
CREATE TABLE [dbo].[Ps_Student_Financial_Aid](
	...
	[Title_I_VParticipant_And_Recipient] [bit] NULL,
...
CREATE TABLE [dbo].[Quarterly_Employment_Record](
	...
	[Employment_NAICSCode] [nvarchar](50) NULL,
	[Reference_Period_Start_Date] [date] NULL,
	[Reference_Period_End_Date] [date] NULL,
	[Ref_ERAdministrative_Data_Source_Id] [int] NULL,
...
CREATE TABLE [dbo].[Ref_Ae_Certification_Type](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK__Ref_Ae_Certification_Type] PRIMARY KEY CLUSTERED 
(
...
CREATE TABLE [dbo].[Ref_Ae_Instructional_Program_Type](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK__Ref_Ae_Instructional_Program_Type] PRIMARY KEY CLUSTERED 
(
...
CREATE TABLE [dbo].[Ref_Amao_Attainment_Status](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK__Ref_Amao_Attainment_Status] PRIMARY KEY CLUSTERED 
(
...
CREATE TABLE [dbo].[Ref_Apip_Interaction_Type](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK__Ref_Apip_Interaction_Type] PRIMARY KEY CLUSTERED 
(
...
;
/****** Object:  Table [dbo].[Ref_Assessment_Accommodation_Type]  ******/
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
CREATE TABLE [dbo].[Ref_Assessment_Accommodation_Type](
	[Ref_Assessment_Accommodation_Type_Id] [int] IDENTITY(1,1) NOT NULL,
	[Description] [nvarchar](100) NOT NULL,
	[Code] [nvarchar](50) NULL,
	[Definition] [nvarchar](4000) NULL,
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK_Assessment_Accommodation_Type] PRIMARY KEY CLUSTERED 
(
	[Ref_Assessment_Accommodation_Type_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [dbo].[Ref_Assessment_Asset_Identifier_Type](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK__Ref_Assesment_Assest_Identifier_Type] PRIMARY KEY CLUSTERED 
(
...
CREATE TABLE [dbo].[Ref_Assessment_Form_Section_Identification_System](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK__Ref_Assessment_Form_Section_Identification_System] PRIMARY KEY CLUSTERED 
(
...
CREATE TABLE [dbo].[Ref_Assessment_Item_Characteristic_Type](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK__Ref_Assessment_Item_Characteristic_Type] PRIMARY KEY CLUSTERED 
(
...
CREATE TABLE [dbo].[Ref_Assessment_Item_Response_Status](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK__Ref_Assessment_Item_Response_Status] PRIMARY KEY CLUSTERED 
(
...
CREATE TABLE [dbo].[Ref_Assessment_Item_Type](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK__Ref_Assessment_Item_Type] PRIMARY KEY CLUSTERED 
(
...
CREATE TABLE [dbo].[Ref_Assessment_Platform_Type](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK__Ref_Assesessment_Platform_Type] PRIMARY KEY CLUSTERED 
(
...
CREATE TABLE [dbo].[Ref_Assessment_Session_Special_Circumstance_Type](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK__Ref_Assessment_Special_Circumstance] PRIMARY KEY CLUSTERED 
(
...
CREATE TABLE [dbo].[Ref_Blooms_Taxonomy_Domain](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK__Ref_Bloom_Taxonomy_Domain] PRIMARY KEY CLUSTERED 
(
...
CREATE TABLE [dbo].[Ref_Calendar_Event_Type](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK__Ref_Calendar_Event_Type] PRIMARY KEY CLUSTERED 
(
...
CREATE TABLE [dbo].[Ref_Child_Development_Associate_Type](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK_Ref_Child_EDevelopment_Associate_Type] PRIMARY KEY CLUSTERED 
(
...
CREATE TABLE [dbo].[Ref_Course_Gpa_Applicability](
	[Ref_Course_GPAApplicability_Id] [int] IDENTITY(1,1) NOT NULL,
	[Description] [nvarchar](100) NOT NULL,
	[Code] [nvarchar](50) NULL,
	[Definition] [nvarchar](4000) NULL,
	[Ref_Jurisdiction_Id] [int] NULL,
...
(
	[Ref_Course_GPAApplicability_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
;
...
;
/****** Object:  Table [dbo].[Ref_DQPCategories_Of_Learning]  ******/
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
CREATE TABLE [dbo].[Ref_DQPCategories_Of_Learning](
	[Ref_DQPCategories_Of_Learning_Id] [int] IDENTITY(1,1) NOT NULL,
	[Description] [nvarchar](100) NOT NULL,
	[Code] [nvarchar](60) NULL,
	[Definition] [nvarchar](4000) NULL,
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](6, 2) NULL,
 CONSTRAINT [PK_Ref_DQPCategories_Of_Learning] PRIMARY KEY CLUSTERED 
(
	[Ref_DQPCategories_Of_Learning_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
;
...
;
/****** Object:  Table [dbo].[Ref_ERAdministrative_Data_Source]  ******/
SET ANSI_NULLS ON;
SET QUOTED_IDENTIFIER ON;
CREATE TABLE [dbo].[Ref_ERAdministrative_Data_Source](
	[Ref_ERAdministrative_Data_Source_Id] [int] IDENTITY(1,1) NOT NULL,
	[Description] [nvarchar](100) NOT NULL,
	[Code] [nvarchar](50) NULL,
	[Definition] [nvarchar](4000) NULL,
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK_Ref_ERAdministrative_Data_Source] PRIMARY KEY CLUSTERED 
(
	[Ref_ERAdministrative_Data_Source_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
;
...
CREATE TABLE [dbo].[Ref_High_School_Diploma_Distinction_Type](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK_Ref_HSDiploma_Distinction_Type] PRIMARY KEY CLUSTERED 
(
...
CREATE TABLE [dbo].[Ref_High_School_Graduation_Rate_Indicator](
	[Ref_HSGraduation_Rate_Indicator_Id] [int] IDENTITY(1,1) NOT NULL,
	[Description] [nvarchar](100) NOT NULL,
	[Code] [nvarchar](50) NULL,
	[Definition] [nvarchar](4000) NULL,
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK_Ref_HSGraduation_Rate_Indicator] PRIMARY KEY CLUSTERED 
(
	[Ref_HSGraduation_Rate_Indicator_Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
;
...
CREATE TABLE [dbo].[Ref_IDEA_Educational_Environment_EC](
	[Ref_IDEA_Educational_Environment_ECId] [int] IDENTITY(1,1) NOT NULL,
	[Description] [nvarchar](100) NOT NULL,
	[Code] [nvarchar](50) NULL,
	[Definition] [nvarchar](4000) NULL,
	[Ref_Jurisdiction_Id] [int] NULL,
...
(
	[Ref_IDEA_Educational_Environment_ECId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
;
...
CREATE TABLE [dbo].[Ref_IDEA_Educational_Environment_School_Age](
	[Ref_IDESEducational_Environment_School_Age] [int] IDENTITY(1,1) NOT NULL,
	[Description] [nvarchar](100) NOT NULL,
	[Code] [nvarchar](50) NULL,
	[Definition] [nvarchar](4000) NULL,
	[Ref_Jurisdiction_Id] [int] NULL,
...
(
	[Ref_IDESEducational_Environment_School_Age] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
;
...
CREATE TABLE [dbo].[Ref_Ipeds_Occupational_Category](
	...
	[Ref_Jurisdiction_Id] [int] NULL,
	[Sort_Order] [decimal](5, 2) NULL,
 CONSTRAINT [PK_Ref_IPEDSOccupational_Category] PRIMARY KEY CLUSTERED 
(
