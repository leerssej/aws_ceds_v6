...
COMMENT ON COLUMN ceds6sc.el_child_outcome_summary.cos_progress_a_indicator IS 'Indicates that the child demonstrates progress in positive social-emotional skills (including social relationships). [CEDS Element: Child Outcomes Summary Progress A Indicator, ID: 001504]';

COMMENT ON COLUMN ceds6sc.el_child_outcome_summary.cos_progress_b_indicator IS 'Indicates that the child demonstrates progress in acquisition and use of knowledge and skills (including early language/communication. [CEDS Element: Child Outcomes Summary Progress A Indicator, ID: 001505]';

COMMENT ON COLUMN ceds6sc.el_child_outcome_summary.cos_progress_c_indicator IS 'Indicates that the child demonstrates progress in use of appropriate behaviors to meet their needs. [CEDS Element: Child Outcomes Summary Progress A Indicator, ID: 001506]';
...
COMMENT ON COLUMN ceds6sc.el_child_transition_plan.part_b619potential_eligibility_ind IS 'The determination of whether a child is potentially eligible for Part B 619 services. [CEDS Element: IDEA Part B 619 Potential Eligibility Indicator, ID: 001360]';
...
COMMENT ON COLUMN ceds6sc.el_class_section_service.organization_id IS 'Foreign key - ELClass_Section';
...
COMMENT ON COLUMN ceds6sc.k12_lea_federal_funds.organization_id IS 'Inherited surrogate key from K12Lea.';
...
COMMENT ON COLUMN ceds6sc.k12_lea_federal_funds.ses_school_choice20percent_obligation IS 'The dollar amount of the 20 percent reservation for supplemental educational services and choice-related transportation. [CEDS Element: Supplemental Education Services Public School Choice Twenty Percent Obligation, ID:000574]';
...
COMMENT ON COLUMN ceds6sc.k12_lea_pre_k_eligibility.organization_id IS 'Foreign key - K12LEA';

COMMENT ON COLUMN ceds6sc.k12_lea_pre_k_eligibility.ref_pre_kindergarten__eligibility_id IS 'The groups of students for whom pre-kindergarten programs are available. [CEDS Element: Pre-kindergarten Eligibility, ID:000216]  (Foreign key - Ref_Pre_Kindergarten__Eligibility)';
...
COMMENT ON COLUMN ceds6sc.k12_lea_safe_drug_free.organization_id IS 'Inherited surrogate key from K12Lea.';
...
COMMENT ON COLUMN ceds6sc.k12_lea_title_i_support_service.organization_id IS 'Foreign key - K12LEA';
...
COMMENT ON COLUMN ceds6sc.k12_program_or_service.organization_id IS 'Surrogate key from K12LEA.';

COMMENT ON COLUMN ceds6sc.k12_program_or_service.ref_pre_kindergarten__daily_length_id IS 'The portion of a day that a pre-kindergarten program is provided to the students it serves. [CEDS Element: Pre_Kindergarten_ Daily Length, ID:000490]  (Foreign key - Ref_Program_Day_Length)';
...
COMMENT ON COLUMN ceds6sc.k12_school_improvement.organization_id IS 'Foreign key - K12School.';
...
COMMENT ON COLUMN ceds6sc.k12_sea_federal_fund_allocation.organization_id IS 'Foreign key - K12Sea';
...
COMMENT ON COLUMN ceds6sc.k12_student_enrollment.nslpdirect_certification_indicator IS 'Indicates that the student''s National School Lunch Program (NSLP) eligibility has been determined through direct certification. [CEDS Element: National School Lunch Program Direct Certification Indicator, ID:001654]';
...
COMMENT ON COLUMN ceds6sc.quarterly_employment_record.ref_eradministrative_data_source_id IS 'Administrative data source of information used to collect employment and earnings-related data. [CEDS Element: Employment Record Administrative Data Source, ID:000994]';
...
CREATE TABLE ceds6sc.ref_eradministrative_data_source ( 
...
COMMENT ON TABLE ceds6sc.ref_eradministrative_data_source IS 'Administrative data source of information used to collect employment and earnings-related data. [CEDS Element: Employment Record Administrative Data Source, ID:000994]';

COMMENT ON COLUMN ceds6sc.ref_eradministrative_data_source.ref_eradministrative_data_source_id IS 'Surrogate Key';

COMMENT ON COLUMN ceds6sc.ref_eradministrative_data_source.description IS 'Administrative data source of information used to collect employment and earnings-related data. [CEDS Element: Employment Record Administrative Data Source, ID:000994]';

COMMENT ON COLUMN ceds6sc.ref_eradministrative_data_source.code IS 'A code or abbreviation for the type.';

COMMENT ON COLUMN ceds6sc.ref_eradministrative_data_source.ref_jurisdiction_id IS 'Surrogate key from Organization identifying the publisher of the reference value.';
...
COMMENT ON TABLE ceds6sc.ref_financial_account_revenue_code IS 'Codes are for recording revenue and other receivables by source. Based on codes specified in the NCES Handbook financial accounting for local and state school systems: 2009 edition [CEDS Element: Financial Account Revenue Code, ID:001468]';
...
CREATE TABLE ceds6sc.ref_pre_kindergarten__eligibility ( 
	ref_pre_kindergarten__eligibility_id integer  NOT NULL,
	description        varchar(100)  NOT NULL,
	code               varchar(50)  ,
	definition         varchar(4000)  ,
...
COMMENT ON TABLE ceds6sc.ref_pre_kindergarten__eligibility IS 'The groups of students for whom pre-kindergarten programs are available. [CEDS Element: Pre-kindergarten Eligibility, ID:000216]';

COMMENT ON COLUMN ceds6sc.ref_pre_kindergarten__eligibility.ref_pre_kindergarten__eligibility_id IS 'Surrogate Key';

COMMENT ON COLUMN ceds6sc.ref_pre_kindergarten__eligibility.description IS 'The groups of students for whom pre-kindergarten programs are available. [CEDS Element: Pre-kindergarten Eligibility, ID:000216]';

COMMENT ON COLUMN ceds6sc.ref_pre_kindergarten__eligibility.code IS 'A code or abbreviation for the type.';

COMMENT ON COLUMN ceds6sc.ref_pre_kindergarten__eligibility.ref_jurisdiction_id IS 'Surrogate key from Organization identifying the publisher of the reference value.';
...
COMMENT ON TABLE ceds6sc.ref_program_day_length IS 'The portion of a day that a program is provided to the students it serves. [CEDS Elements: Kindergarten Daily Length (000491), Pre_Kindergarten_ Daily Length (000490)]';

COMMENT ON COLUMN ceds6sc.ref_program_day_length.ref_program_day_length_id IS 'Surrogate Key';

COMMENT ON COLUMN ceds6sc.ref_program_day_length.description IS 'The portion of a day that a program is provided to the students it serves. [CEDS Elements: Kindergarten Daily Length (000491), Pre_Kindergarten_ Daily Length (000490)]';
...
COMMENT ON TABLE ceds6sc.ref_reconstituted_status IS 'An indication that the school was restructured, transformed or otherwise changed as a consequence of the state<U+0092>s accountability system under ESEA or as a result of School Improvement Grants (SIG). [CEDS Element: Reconstituted Status, ID:000230]';
...
CREATE TABLE ceds6sc.assessment_el_developmental_domain ( 
...
COMMENT ON TABLE ceds6sc.assessment_el_developmental_domain IS 'Developmental domains related to early learning and used for assessing a child''s kindergarten readiness. [CEDS Element: Assessment Early Learning Developmental Domain, ID:001000]';

COMMENT ON COLUMN ceds6sc.assessment_el_developmental_domain.assessment_el_developmental_domain_id IS 'Surrogate Key';

COMMENT ON COLUMN ceds6sc.assessment_el_developmental_domain.assessment_id IS 'Foreign key - Assessment';

COMMENT ON COLUMN ceds6sc.assessment_el_developmental_domain.ref_assessment_el_developmental_domain_id IS 'Foreign key - Ref_Assessment_EL_Developmental_Domain';
...
COMMENT ON COLUMN ceds6sc.course.sced_sequence_of_course IS 'Where a specific course lies when it is part of a consecutive sequence of courses. This element should be interpreted as "part ''n'' of ''m'' parts. [CEDS Element: School Courses for the Exchange of Data Sequence of Course, ID:000250]';
...
COMMENT ON COLUMN ceds6sc.el_child_services_application.el_application_identifier IS 'Identifier for the application for enrollment or direct services filled out on behalf of a child [CEDS Element: Early Learning Application Identifier, ID:001597]';
...
COMMENT ON COLUMN ceds6sc.el_child_services_application.el_application_required_document IS 'Identifies a specific document required for enrollment. [CEDS Element: Early Learning Application Required Document, ID:001599]';
...
COMMENT ON COLUMN ceds6sc.el_enrollment.el_class_section_id IS 'Foreign key - ELClass_Section.';
...
COMMENT ON COLUMN ceds6sc.el_organization_funds.ref_el_local_revenue_source_id IS 'Funds that originate at the local level, and not from the state or federal level, that contribute to EL program. [CEDS Element: Early Learning Local Revenue Source, ID:001603]';

COMMENT ON COLUMN ceds6sc.el_organization_funds.ref_el_other_federal_funding_sources_id IS 'The other contributing funding sources. [CEDS Element: Early Learning Other Federal Funding Sources, ID:001335]';

COMMENT ON COLUMN ceds6sc.el_organization_funds.ref_el_state_revenue_source_id IS ' Funds that originate at the State, and not from a federal or local source, that contribute to EL program. [CEDS Element: Early Learning State Revenue Source, ID:001605]';
...
COMMENT ON COLUMN ceds6sc.el_staff_education.ref_el_level_of_specialization_id IS 'The extent to which a person concentrates upon a particular subject matter area during his or her period of study at an educational institution. [CEDS Element: Level of Specialization in Early Learning, ID:000341]';
...
COMMENT ON COLUMN ceds6sc.el_staff_education.school_age_education_ps_credits IS 'The number of college course credit hours an individual has successfully completed that are related to K-12 education, parks and recreation, and juvenile justice. [CEDS Element: Number of School-age Education Postsecondary Credit Hours, ID:000816]';

COMMENT ON COLUMN ceds6sc.el_staff_education.ref_el_professional_development_topic_area_id IS 'The topical area of competence needed for  professional development. [CEDS Element: Early Learning Professional Development Topic Area, ID:001337]';
