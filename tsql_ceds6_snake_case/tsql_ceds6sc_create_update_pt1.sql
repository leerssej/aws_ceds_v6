...
begin
EXEC [CEDS_TSQL_v6sc].[dbo].[sp_fulltext_database] @action = 'enable'
end;

ALTER DATABASE [CEDS_TSQL_v6sc] SET ANSI_NULL_DEFAULT OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET ANSI_NULLS OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET ANSI_PADDING OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET ANSI_WARNINGS OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET ARITHABORT OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET AUTO_CLOSE OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET AUTO_CREATE_STATISTICS ON ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET AUTO_SHRINK OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET AUTO_UPDATE_STATISTICS ON ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET CURSOR_CLOSE_ON_COMMIT OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET CURSOR_DEFAULT  GLOBAL ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET CONCAT_NULL_YIELDS_NULL OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET NUMERIC_ROUNDABORT OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET QUOTED_IDENTIFIER OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET RECURSIVE_TRIGGERS OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET  ENABLE_BROKER ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET AUTO_UPDATE_STATISTICS_ASYNC OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET DATE_CORRELATION_OPTIMIZATION OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET TRUSTWORTHY OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET ALLOW_SNAPSHOT_ISOLATION OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET PARAMETERIZATION SIMPLE ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET READ_COMMITTED_SNAPSHOT OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET HONOR_BROKER_PRIORITY OFF ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET  READ_WRITE ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET RECOVERY FULL ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET  MULTI_USER ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET PAGE_VERIFY CHECKSUM  ;
ALTER DATABASE [CEDS_TSQL_v6sc] SET DB_CHAINING OFF ;
